...
public interface BillRepository extends JpaRepository<Bill, Integer> {
    ...
    @Query(value = "SELECT SUM(TotalPrice) FROM Bill WHERE MONTH(Time) = :month AND YEAR(Time) = :year", nativeQuery = true)
    Integer findSumTotalPriceByMonth(@Param("month") String month, @Param("year") String year);
}

...
public class AdminItemController {
    ...
    @PostMapping("/delete")
    public ResponseEntity<ResponseData<Void>> deleteItemById(@RequestParam("param") Integer itemId) {
    ...
    public ResponseEntity<ResponseData<Void>> deleteItemByCode(@PathVariable(value = "code") String code) {
